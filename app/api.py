...
class Amazon(AmazonAPI):
	...
	def __init__(self, region='US', key=None, secret=None, tag=None, **kwargs):
		"""
		...
		"""
		key = (key or getenv('AWS_ACCESS_KEY_ID'))
		secret = (secret or getenv('AWS_SECRET_ACCESS_KEY'))
		tag = (tag or getenv('AWS_ASSOCIATE_TAG'))
